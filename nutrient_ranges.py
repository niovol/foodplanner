...
#'very_active': 1.725,
#'extra_active': 1.9
def calculate_calories(gender, current_weight, goal_weight, height, age, activity_multiplier,
                       breastfeeding=False, formula='mifflin_st_jeor'):
    ...
    if formula == 'mifflin_st_jeor':
        ...
        raise ValueError("Invalid formula specified. Use 'mifflin_st_jeor' or 'harris_benedict'.")

    calories_current_maintenance = bmr_current * activity_multiplier + breastfeeding * 500
    ...
    if excess_weight >= max_excess_weight:
        ...
        calories_recomendations = calories_goal_maintenance + interpolation_coefficient * (calories_weight_loss - calories_goal_maintenance)

    return {'kcal_current_maintenance': calories_current_maintenance,
...
def calculate_nutrient_ranges(gender, height, weight_cur, age, activity_multiplier, breastfeeding=False):
    params = {}
    ...
    calories = calculate_calories(gender, weight_cur, optimal_weight, height*100, age, activity_multiplier, breastfeeding=breastfeeding)
    ...
    params['Lipid_Tot_(g)'] = get_lipid_range(kcal_current_maintenance, kcal_recomendations)
    params['Carbohydrt_(g)'] = get_carbohydrate_range(kcal_recomendations, params['Protein_(g)'][2], params['Lipid_Tot_(g)'][2])
...
def get_lipid_range(kcal_current_maintenance, kcal_recomendations):
    return np.array([0.2 * kcal_recomendations,
                     0.25 * kcal_recomendations,
                     0.275 * kcal_recomendations,
                     0.275 * kcal_recomendations,
                     0.3 * kcal_recomendations]) / 9
...
def get_energy_range(kcal_recomendations):
    return np.array([kcal_recomendations - 200,
...
def get_saturated_fat_range(kcal_recomendations):
    return np.array([0, 0, 0, 0.05 * kcal_recomendations / 9, 0.1 * kcal_recomendations / 9])

def get_sugar_range(kcal_recomendations):
    return np.array([0, 0, 0, 0.05 * kcal_recomendations / 4, 0.1 * kcal_recomendations / 4])
...
def get_female_vitamins_and_minerals(breastfeeding):
    return {
        'Calcium_(mg)': np.array([800 + 400 * breastfeeding,
                                  1000 + 400 * breastfeeding,
                                  1200 + 400 * breastfeeding,
                                  2000,
                                  2500]),
        'Iron_(mg)': np.array([18,
                               18 + 9 * breastfeeding,
                               18 + 9 * breastfeeding,
                               36,
                               45]),
        'Magnesium_(mg)': np.array([310, 320, 400, 500, 600]) + 50 * breastfeeding,
        'Phosphorus_(mg)': np.array([800 + 200 * breastfeeding,
        ...
        'Sodium_(mg)': np.array([1300, 1500, 1750, 2000, 2300]),
        'Zinc_(mg)': np.array([10 + 3 * breastfeeding,
                               12 + 3 * breastfeeding,
                               15,
                               25,
                               40]),
        'Copper_mg)': np.array([0.9 + 0.4 * breastfeeding,
                                1 + 0.4 * breastfeeding,
                                1.5 + 0.4 * breastfeeding,
                                3,
                                10]),
        'Manganese_(mg)': np.array([1.8 + 0.8 * breastfeeding,
                                    2 + 0.8 * breastfeeding,
                                    2 + 0.8 * breastfeeding,
                                    5,
                                    11]),
        'Selenium_(µg)': np.array([55 + 15 * breastfeeding,
                                   55 + 15 * breastfeeding,
                                   55 + 15 * breastfeeding,
                                   300,
                                   400]),
        'Vit_C_(mg)': np.array([90 + 30 * breastfeeding,
                                120 + 30 * breastfeeding,
                                150 + 30 * breastfeeding,
                                500,
                                2000]),
        'Thiamin_(mg)': np.array([1.1 + 0.3 * breastfeeding,
                                  1.5 + 0.3 * breastfeeding,
                                  1.8 + 0.3 * breastfeeding,
                                  5 * breastfeeding,
                                  10]),
        'Riboflavin_(mg)': np.array([1.1 + 0.5 * breastfeeding,
                                     1.8 + 0.3 * breastfeeding,
                                     2 + 0.3 * breastfeeding,
                                     5,
                                     10]),
        'Niacin_(mg)': np.array([14 + 3 * breastfeeding,
                                 20 + 3 * breastfeeding,
                                 20 + 3 * breastfeeding,
                                 35,
                                 60]),
        'Panto_Acid_mg)': np.array([5 + 2 * breastfeeding,
                                    5 + 2 * breastfeeding,
                                    5 + 2 * breastfeeding,
                                    10,
                                    20]),
        'Vit_B6_(mg)': np.array([1.3 + 0.6 * breastfeeding,
                                 2 + 0.5 * breastfeeding,
                                 2 + 0.5 * breastfeeding,
                                 25,
                                 100]),
        'Folate_Tot_(µg)': np.array([400 + 100 * breastfeeding,
                                     400 + 100 * breastfeeding,
                                     400 + 100 * breastfeeding,
                                     800,
                                     1000]),
        'Choline_Tot_ (mg)': np.array([425 + 125 * breastfeeding,
                                       425 + 125 * breastfeeding,
                                       750,
                                       1000,
                                       3500]),
        'Vit_B12_(µg)': np.array([2.4 + 0.4 * breastfeeding,
                                  3 + 0.5 * breastfeeding,
                                  3 + 0.5 * breastfeeding,
                                  10,
                                  20]),
        'Vit_A_RAE': np.array([900 + 400 * breastfeeding,
                               1300 + 200 * breastfeeding,
                               1500 + 200 * breastfeeding,
                               2000,
                               3000]),
        'Vit_E_(mg)': np.array([15 + 4 * breastfeeding,
                                15 + 4 * breastfeeding,
                                15 + 4 * breastfeeding,
                                300,
                                1000]),
